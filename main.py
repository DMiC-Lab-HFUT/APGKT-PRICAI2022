...
def main():
    ...
    arg_parser.add_argument("--lr", type=float, default=0.007105)
    arg_parser.add_argument("--lr_decay", type=float, default=0.8933)
    ...
    arg_parser.add_argument('--dataset', type=str, default='math2')
    ...
    arg_parser.add_argument('--question_neighbor_num', type=int, default=10)
    arg_parser.add_argument('--Q_Modes', type=dict, default={})
